 ...
 * @see com.clps.demo.domain.Account
...
public class AccountHome {
	...
	public Account findById(java.lang.String id) {
		...
		try {
			Account instance = (Account) sessionFactory.getCurrentSession().get("com.clps.demo.domain.Account", id);
			if (instance == null) {
	...
	public List findByExample(Account instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.clps.demo.domain.Account")
