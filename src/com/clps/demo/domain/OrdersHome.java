 ...
 * @see com.clps.demo.domain.Orders
...
public class OrdersHome {
	...
	public Orders findById(int id) {
		...
		try {
			Orders instance = (Orders) sessionFactory.getCurrentSession().get("com.clps.demo.domain.Orders", id);
			if (instance == null) {
	...
	public List findByExample(Orders instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.clps.demo.domain.Orders")
