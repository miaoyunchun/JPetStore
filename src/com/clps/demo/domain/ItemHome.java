...
public class ItemHome {
	...
	public Item findById(java.lang.String id) {
		...
		try {
			Item instance = (Item) sessionFactory.getCurrentSession().get("com.clps.demo.domain.Item", id);
			if (instance == null) {
	...
	public List findByExample(Item instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.clps.demo.domain.Item")
