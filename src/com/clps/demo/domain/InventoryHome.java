 ...
 * @see com.clps.demo.domain.Inventory
...
public class InventoryHome {
	...
	public Inventory findById(java.lang.String id) {
		...
		try {
			Inventory instance = (Inventory) sessionFactory.getCurrentSession().get("com.clps.demo.domain.Inventory",
					id);
			if (instance == null) {
	...
	public List findByExample(Inventory instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.clps.demo.domain.Inventory")
