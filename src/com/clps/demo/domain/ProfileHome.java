 ...
 * @see com.clps.demo.domain.Profile
...
public class ProfileHome {
	...
	public Profile merge(Profile detachedInstance) {
		...
		try {
			Profile result = (Profile) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Profile findById(java.lang.String id) {
		log.debug("getting Profile instance with id: " + id);
		try {
			Profile instance = (Profile) sessionFactory.getCurrentSession().get("com.clps.demo.domain.Profile", id);
			if (instance == null) {
	...
	public List findByExample(Profile instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.clps.demo.domain.Profile")
