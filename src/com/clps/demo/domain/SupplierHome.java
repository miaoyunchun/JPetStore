 ...
 * @see com.clps.demo.domain.Supplier
...
public class SupplierHome {
	...
	public Supplier findById(int id) {
		...
		try {
			Supplier instance = (Supplier) sessionFactory.getCurrentSession().get("com.clps.demo.domain.Supplier", id);
			if (instance == null) {
	...
	public List findByExample(Supplier instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.clps.demo.domain.Supplier")
