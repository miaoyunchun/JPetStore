 ...
 * @see com.clps.demo.domain.Category
...
public class CategoryHome {
	...
	public Category findById(java.lang.String id) {
		...
		try {
			Category instance = (Category) sessionFactory.getCurrentSession().get("com.clps.demo.domain.Category", id);
			if (instance == null) {
	...
	public List findByExample(Category instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.clps.demo.domain.Category")
