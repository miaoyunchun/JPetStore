...
<script type="text/javascript">
	$(function(){
		...
		$(".sumprice").each(function(){
				var price = $(this).parent().parent().parent().children().eq(4).html()
				var count = $(this).parent().parent().parent().children().eq(3).html();
...
<div id="Catalog">
<div id="BackLink">
<a href="<%=basePath %>/queryShoppingAction?begin=0&signon.userid=${userid }">返回到购物车</a>
</div>
    ...
    <tr>
      <td>
        ...
        <table>
          ...
          <tr>
            <td><b>商品编号</b></td>  <td><b>产品编号</b></td>  <td><b>产品描述</b></td> 
            <td><b>产品数量</b></td>  <td><b>定价</b></td> <td><b>商品总价</b></td>
          </tr>
        ...
        <s:iterator value="listcart" var="cart">
		    	<tr>
		            ...
		            <td> <span style="color:red;font-weight:bold">$  <span class="sumprice">0</span></span></td>
          ...
          <tr>
            <td colspan="7">
             <p style="color:red;font-weight:bold"> 总金额:&nbsp;&nbsp;&nbsp;$&nbsp;<span id="maxprice"></span></p> 
