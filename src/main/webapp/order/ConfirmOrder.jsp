...
请确认以下信息，然后按"继续"...
  ...
  <table>
    ...
    <tr><td>
    姓名:</td><td>	<s:property value="account.firstname"/> <s:property value="account.lastname"/>
    </td></tr>
    ...
    <tr><td>
      地址 2:</td><td><s:property value="account.addr2"/>    </td></tr>
    <tr><td>
      城市: </td><td>	<s:property value="account.city"/>
    </td></tr>
    <tr><td>
      区、县:</td><td><s:property value="account.state"/> 
    </td></tr>
    <tr><td>
  ...
  寄运地址
   ...
   城市: </td><td><s:property value="account.city"/> 
    ...
    <form action="saveOrderAction?signon.userid=${userid }" method="post">
  			...
  			<input type="hidden" name="orders.billtolastname"  value="<s:property value="account.lastname" />" />
