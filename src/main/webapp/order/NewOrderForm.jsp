  ...
  <form action="<%=basePath %>/order/ConfirmOrder.jsp"  method="post">
   ...
   付款详情
    ...
    账单地址
      ...
      <tr><td>
       姓名:</td><td><input type="text" value="<s:property value="account.firstname"/> <s:property value="account.lastname"/>" />
      </td></tr>
      <tr><td>
       地址1:</td><td><input type="text" size="40" value="<s:property value="account.addr1"/>" />
      </td></tr>
      <tr><td>
      地址2:</td><td><input type="text" size="40" value="<s:property value="account.addr2"/>" />
      </td></tr>
      <tr><td>
