...
<div id="BackLink">
  ...
  <table>
   ...
   <%--  <tr><td>
     ...
     <%int begin=(int)session.getAttribute("begin");
      if(begin==0) {%>
      
		  <font  color="blue">首页</font>
		 
		
		<a class="Button" href="productAction?begin=${begin+1 }&product.productid=<s:property value="product.productid"/>">下一页</a>&nbsp;&nbsp; 
	  <%} else{ %>
	    <a class="Button" href="productAction?begin=${begin-1 }&product.productid=<s:property value="product.productid"/>"/>上一页</a>&nbsp;&nbsp;
