...
<div id="Welcome" style="background:white">
  <div id="WelcomeContent" >
        ...
        欢迎   <font size="5" face="arial" color="red"><s:property value="#session.userid" /></font>!
...
<div id="Main">
  ...
  <div id="Sidebar">
    <div id="SidebarContent">
        ...
        <img src="<%=basePath%>/images/fish_icon.gif"/>
      <br/>
      海水，淡水
      <br/>
  
        <img src="<%=basePath%>/images/dogs_icon.gif"/>
      <br/>
      不同品种
      <br/>
       
        <img src="<%=basePath%>/images/cats_icon.gif"/>
      <br/>
     不同品种，外来品种
      <br/>
    
        <img src="<%=basePath%>/images/reptiles_icon.gif"/>
      <br/>
   蜥蜴，龟，蛇
      <br/>
         
        <img src="<%=basePath%>/images/birds_icon.gif"/>
      <br/>外来品种
    </div>
  </div>
