...
<table id="accountTwoTable">
  ...
  <td>地址2:</td><td><input type=text  size="40" value="<s:property value="account.addr2"/>" name="account.addr2"/></td>
</tr><tr>
  <td>城市:</td><td><input type=text  size="40"  value="<s:property value="account.city"/>" name="account.city"/></td>
</tr><tr>
